...
const StockInfo: FC<props> = ({
  ...
  return (
    // <div className="contstock" onClick={() => setModel1Info(stock)}>
       <div className="card1" onClick={() => setModel1Info(stock)}>
          <div className="title">
            <span>
              <svg
                width="20"
            ...
            <p className="title-text" style={{fontWeight: 'bold'}}>{stock.stockName.toUpperCase()}</p>
            <p className="percent">
          ...
          <div className="data1">
            <p>{stock.stockCurrentPrice.price}$</p>
